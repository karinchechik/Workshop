...
$sql="INSERT INTO fun
			(date, main_title, image, name)
			VALUES 
			('".$_POST["date"]."','".$_POST["main_title"]."','$image','$name')";
...
<html>
	...
	<body>
		...
		<main>
			...
			<h1 class="main-con-title"><span class="end-sign">[</span> יצירת עמוד פנאי <span class="start-sign">]</span></h1>
			<div id="row-content" class="row">
				...
				<div class="col-md-6 col-sm-6">
					<p><a href="fun.html" class="btn btn-primary btn-new btn-style" role="button">צור כתבה חדשה</a></p>
				</div>
			</div>
		</main>
	</body>
