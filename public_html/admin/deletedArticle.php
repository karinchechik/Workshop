...
$sql="UPDATE articles SET
			display=1 WHERE main_title0='".$_POST["main_title0"]."'";
...
<html>
	...
	<body>
		...
		<main>
			...
			<h1 class="main-con-title"><span class="end-sign">[</span> מחיקת כתבה <span class="start-sign">]</span></h1>
			<div id="row-content" class="row">
				<h3 class="postSuccess">הכתבה נמחקה בהצלחה!</h3>
				<div class="col-md-6 col-sm-6">
					<p class="btn-home"><a href="index.html" class="btn btn-primary btn-style" role="button">חזור לעמוד הראשי</a></p>
				</div>
				<div class="col-md-6 col-sm-6">
					<p><a href="deleteArticle.html" class="btn btn-primary btn-new btn-style" role="button">מחיקת כתבה נוספת</a></p>
				</div>
			</div>
		</main>
	</body>
