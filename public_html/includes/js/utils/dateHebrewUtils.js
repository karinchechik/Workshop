function MonSinceFirstMolad(nYearH) {
  ...
  function FormatDateH(cDate) {
    ...
    switch (Number(aDate[0])) {
      ...
      case 6:
        ...
        break
      case 7:
        cFormatDate = (IsLeapYear(Number(aDate[2])) ? "אדר" : "אדר ב")
        break
      case 8:
        cFormatDate = "ניסן"
        break
  ...
  function getHebrewDate() {
    ...
    date = new Date(date);
 	var hebrewDate = GregToHeb(date);
 	var hebrewDateFormatted = FormatDateH(hebrewDate);
 	
 	return {
 		day: gematria(hebrewDateFormatted.day),
 		month: hebrewDateFormatted.month,
 		year: gematria(hebrewDateFormatted.year)
 	};
  }
