...
/**second article in the page- smallOne [2] */
    echo '<h3 class="small-main-title">' .$article2["date"] . '</h3>';
    ...
    echo '<p class="small-content">'. $article2["articleSmall"] .'</p>';
    echo '<img class="content-img">';
    echo '<hr>';

/**third article in the page- smallOne [1]*/
    echo '<h1 class="small-main-title">' .$article3["date"] . '</h1>';
    ...
    echo '<p class="small-content">'. $article3["articleSmall"] .'</p>';
    echo '<img class="content-img">';
    echo '<hr>';
