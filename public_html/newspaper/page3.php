...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../includes/style/visitor/page3.css">
	...
	<body>
		...
		<main id="page5">
			<div class="wrapper">
				...
				<div id="smallArticlesContainer" class="yome-border">
		...
		<button type="button"><a href="page4.php">לעמ' הבא </a> </button>
	</body>
</html>