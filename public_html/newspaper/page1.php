...
<html>
	<head>
     ...
     <!--   <link href="../includes/style/visitor/index.css" rel="stylesheet" type="text/css">-->
        ...
        <link rel="stylesheet" type="text/css" href="../includes/style/visitor/page1.css">
	...
	<body>
		...
		<main id="page1">
			<div class="wrapper">
				...
				<div id="secondContainer">
                    <div id="first-article-container" class="yome-border">
                        <div id="first-article">
                            <?php
                            /**first article in the page- smallOne [0] */
                            echo '<h2 class="small-main-title">' .$article1["main_title3"] . '</h2>';
                            echo '<h3 class="samll-sub-title">' .$article1["sub_title3"] . '</h3>';
                            ?>
				...
				<div id="second-article">
                    ...
                    /**second article in the page- smallOne [0] */
                        echo '<h2 class="small-main-title">' .$article2["main_title3"] . '</h2>';
                        echo '<h3 class="small-sub-title">' .$article2["sub_title3"] . '</h3>';
                    ?>
                    <div class="photograpAndPageNumberContainer">
                        <?php
                        echo '<p class="writer-and-photographer">'.'צילום: '. $article2["articlePhotographer3"] .'</p>';
                        ?>
                        <p class="pageNumber">עמ' 2</p>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
				</div>
				<div id="thirdContainer">
					<div id="third-article">
                        <?php
                            ...
                            echo '<h2 class="small-main-title">' .$article3["main_title3"] . '</h2>';?>
                        <div class="photograpAndPageNumberContainer">
                            <?php
                            echo '<p class="writer-and-photographer">'.'צילום: '. $article3["articlePhotographer3"] .'</p>';
                            ?>
                    ...
                    <div id="forth-article-container" class="yome-border">
                        <div id="forth-article">
                            ...
                            echo '<h2 class="small-main-title">' .$article4["main_title3"] . '</h2>';
                            echo '<h3 class="small-sub-title">' .$article4["sub_title3"] . '</h3>';
            ...
            <button type="button"><a href="page2.php" data-transition="slide" data-direction="reverse">לעמ' הבא </a> </button>
		</main>
	</body>
</html>