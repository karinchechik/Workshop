...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../includes/style/newspaper/page6.css">
...
<body>
<div class="page-container page6">
    ...
    <div class="articles-container row">
        <div class="top-pane">
            <div class="first-article-container article-click-container" data-article="<?php echo $article1["id"]?>" data-article-type="2">
                <div class="titlesContainer">
                    <h2><?php echo $article1["main_title2"] ?></h2>
                    <h4><?php echo $article1["sub_title2"] ?></h4>
                </div>
                <div class="writer-container">
                   <span><?php echo $article1["articleWriter"] ?></span>
                </div>
        ...
        <div class="bottom-pane">
            <div class="content-container">
                <div class="content">
                    <div class="article-click-container" data-article="<?php echo $article2["id"]?>" data-article-type="3">
                        ...
                        <div class="article-content">
                            <?php echo $article2["articleSmall"] ?>
                        </div>
                        <div class="writer"><?php echo $article2["articleWriter"] ?></div>

                        <div class="separator"></div>
                    </div>
                    <div class="article-click-container" data-article="<?php echo $article3["id"]?>" data-article-type="3">
                        <h3><?php echo $article3["main_title3"] ?></h3>
                        <div class="article-content">
                            <?php echo $article3["articleSmall"] ?>
                        </div>
                        <div class="writer"><?php echo $article3["articleWriter"] ?></div>
                        <!--            <img class="content-img" src="data:image/jpeg;base64, <?php /*echo $article3["image3"] */?> ">;-->
                        <img src="../includes/images/sample/small-pic-temp.png"> </img>
                        <div class="separator"></div>
                    </div>
                </div>
