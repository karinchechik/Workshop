...
/***commercial***/
$category_commercial = $selections->interests[2]->id;
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../includes/style/newspaper/page11.css">
...
<body>
<div class="page-container page11">
    <header class="row left-align">
        <div class="circle"><span>11</span></div>
